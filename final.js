...
//the objects
var _ship, sun, vinyl, moon, laser, star, tattoin, jupiter, redplanet, rain1, rain2;

//all of the bounding boxes
var ship_bound, sun_bound, vinyl_bound, moon_bound, laser_bound, star_bound, tattoin_bound, jupiter_bound, redplanet_bound,
...
function drawSpace() {
	...
	//add the vinyl
	vinyl = new THREE.Object3D();
	vinyl.position.set(-44,-1000,1);

	var loader = new THREE.JSONLoader();
	loader.load('vinyl.json', function(geometry, materials) {
			mesh = new THREE.Mesh(geometry, new THREE.MeshFaceMaterial(materials));
	...
	scene.add(_ship, sun, vinyl, moon, jupiter, rain1, rain2, redplanet, tattoin, star, laser);
}
...
function animate() {
	...
	vinyl_bound.setFromObject(vinyl);
	...
	if(keyboard.pressed("W")) {
		...
		ship_bound.intersectsBox(vinyl_bound) ||
